...
function initFooter() {
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 text-sm">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 pb-6 text-center md:text-left">
            <!-- Sobre -->
            <div class="reveal">
                ...
                <div class="flex justify-center md:justify-start gap-4 mt-4 text-texto-claro">
